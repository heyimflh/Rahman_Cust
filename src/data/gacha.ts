...
export const gachaRewards: GachaReward[] = [
  ...
  { id: "g5", message: "Kamu keren, udah bertahan sejauh ini \u2014 dan itu nggak kecil.", type: "pujian", rarity: "kok bisa se-gemas ini" },
  { id: "g6", message: "Kalau ada penghargaan \"teman paling random\", kamu yang bawa pulang.", type: "pujian", rarity: "gemas" },
